...
{
  sub[0] = nh.subscribe("Script_1", 1000, &Script_subscriber::Script_node_1, this);
  sub[1] = nh.subscribe("Script_2", 1000, &Script_subscriber::Script_node_2, this);
  sub[2] = nh.subscribe("Script_3", 1000, &Script_subscriber::Script_node_3, this);
  sub[3] = nh.subscribe("Script_4", 1000, &Script_subscriber::Script_node_4, this);
  sub[4] = nh.subscribe("Script_5", 1000, &Script_subscriber::Script_node_5, this);
  sub[5] = nh.subscribe("Script_6", 1000, &Script_subscriber::Script_node_6, this);
  sub[6] = nh.subscribe("Script_7", 1000, &Script_subscriber::Script_node_7, this);
}

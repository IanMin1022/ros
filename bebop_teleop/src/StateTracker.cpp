...
void StateTracker::subscribe(ros::NodeHandle& nh) {
	sub[0] = nh.subscribe("bebop_4/states/common/CommonState/BatteryStateChanged", 100, &StateTracker::setBattery, this);
	sub[2] = nh.subscribe("bebop_4/odom", 100, &StateTracker::setOdom, this);
	sub[1] = nh.subscribe("bebop_4/states/common/CommonState/WifiSignalChanged", 100, &StateTracker::setWifi, this);
	sub[3] = nh.subscribe("bebop_4/fix", 100, &StateTracker::setPos, this);
